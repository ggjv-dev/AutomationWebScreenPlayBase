                    ...
                    steps
                            {
                                checkout([$class: 'GitSCM', branches: [[name: "master"]],
                                        ...
                                        [credentialsId: "AzureGITRepos", url: "https://DEV-FormacionCH@dev.azure.com/DEV-FormacionCH/Pilot/_git/ProyectoBaseWebPOM"]
                                ]])
                            }
                }
                        ...
                        script
                                {
                                    try
                                    {
                                        ...
                                        bat "start cmd.exe /c historics\\historicReport.bat"
